...
//      System.out.println("You have to pay " + reservation.getTotalFee());
	...
	void updateSchedule() {
        ...
        List<Showing> schedule1 = List.of(
                new Showing(movie1, 1, LocalDateTime.of(datePlus2, LocalTime.of(9, 0))),
                new Showing(movie2, 2, LocalDateTime.of(datePlus2, LocalTime.of(11, 0))),
                new Showing(movie3, 3, LocalDateTime.of(datePlus2, LocalTime.of(12, 50))));
